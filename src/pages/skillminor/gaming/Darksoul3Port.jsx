...
import "./Darksoul3PortStyle.css";

export default function DS3() {
  
  return (
    <section className="darksoul3port">
        
        <img className="DSimage" src = "Screenshot 2025-08-19 190553.png"></img>

        <div>
            <h1>Complete All Achievement in Dark Souls III</h1>
            <div className="DS3Line"></div>
            <p>
            ...
            <p>
                ...
                <strong>persistence is the key to success.</strong><br></br>
            </p>
        </div>
    </section>
  );
